 ...
 * NTNU - Norway
 * 
 * observabilityactivepowergrytoya.js
 * ===================================
 * 
 * Send request to esb
 * and make plot.
...
GIFTWIN.esb.plot.observabilityActivePower = (() => {
...
<form action="javascript:void(0)">
   <fieldset>
      <legend class="doc">Observability - active power</legend>
      ...
      <label for="meterId">Meter id</label>
         <input list="meterIdsObservabilityActivePower" class="meterId" placeholder="Select from list or edit"/>
         <datalist id="meterIdsObservabilityActivePower">
