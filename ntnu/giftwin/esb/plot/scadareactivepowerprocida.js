...
GIFTWIN.esb.plot.scadaReActivePower = (() => {
 ...
 <fieldset>
 <legend class="doc">SCADA - reactive power</legend>
 ...
 <input list="meterIdsSCADAreActivePower" class="meterId" placeholder="Select from list or edit"/>
 <datalist id="meterIdsSCADAreActivePower">
