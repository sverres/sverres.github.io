...
GIFTWIN.esb.plot.vpsLoadCurveProcida = (() => {
...
<form action="javascript:void(0)">
   <fieldset>
      <legend class="doc">VPS - load curve</legend>
      ...
      <datalist id="vpsId">
            <option value="5-PIE-002">Chiaiolella lifting plant</option>
            <option value="5-PIE-003">City Hall/Office building</option>
            <option value="5-PIE-007">Raia lifting plant</option>
            <option value="5-PIE-009">Pozzoveccio lifting plant</option>
            <option value="5-PIE-010">Tortora lifting plant</option>
            <option value="5-PPE-001">City Hall charger</option>
            <option value="5-PPE-002">Middle school parking charger</option>
            <option value="5-PPE-003">Harbour area charger</option>
            <option value="5-PRE-CD-001">Li-ion battery City Hall</option>
      </datalist>
