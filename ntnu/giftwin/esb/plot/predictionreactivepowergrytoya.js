 ...
 * NTNU - Norway
 * 
 * predictionreactivepowergrytoya.js
 * ==================================
 * 
 * Send request to esb
 * and make plot.
...
GIFTWIN.esb.plot.predictionReActivePower = (() => {
...
<form action="javascript:void(0)">
   <fieldset>
      <legend class="doc">Prediction - active power</legend>
      ...
      <label for="meterId">Meter id</label>
         <input list="meterIdsPredictionReActivePower" class="meterId" placeholder="Select from list or edit"/>
         <datalist id="meterIdsPredictionReActivePower">
