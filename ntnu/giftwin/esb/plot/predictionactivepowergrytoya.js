 ...
 * NTNU - Norway
 * 
 * predictionactivepowergrytoya.js
 * ================================
 * 
 * Send request to esb
 * and make plot.
...
GIFTWIN.esb.plot.predictionActivePower = (() => {
...
<form action="javascript:void(0)">
   <fieldset>
      ...
      <label for="meterId">Meter id</label>
         <input list="meterIdsPredictionActivePower" class="meterId" placeholder="Select from list or edit"/>
         <datalist id="meterIdsPredictionActivePower">
